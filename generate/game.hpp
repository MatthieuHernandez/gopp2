...
#ifndef GAME_H_CPP2
#error This file is part of a '.h2' header compiled to be consumed from another -pure-cpp2 file. To use this file, write '#include "game.h2"' in a '.h2' or '.cpp2' file compiled with -pure-cpp2.
#endif

#ifndef GAME_HPP_CPP2
#define GAME_HPP_CPP2
...
#line 21 "../src/game.h2"
    [[nodiscard]] auto Game::canBeStopped() const& -> bool{
        return !(isSaving); 
    }
