...
#line 65 "../src/main.cpp2"
            else if (cpp2::impl::is(_expr, 6)) { if constexpr( requires{[]() -> bool{clear();auto player1 {CPP2_UFCS_TEMPLATE(cpp2_new<Ai>)(cpp2::shared, Color::Black)}; auto player2 {CPP2_UFCS_TEMPLATE(cpp2_new<Ai>)(cpp2::shared, Color::White)}; auto game {Game(cpp2::move(player1), cpp2::move(player2))}; cpp2::i32 i {0}; while( true ) {CPP2_UFCS_TEMPLATE(play<false>)(game);++i;}return false; }();} ) if constexpr( std::is_convertible_v<CPP2_TYPEOF(([]() -> bool{clear();auto player1 {CPP2_UFCS_TEMPLATE(cpp2_new<Ai>)(cpp2::shared, Color::Black)}; auto player2 {CPP2_UFCS_TEMPLATE(cpp2_new<Ai>)(cpp2::shared, Color::White)}; auto game {Game(cpp2::move(player1), cpp2::move(player2))}; cpp2::i32 i {0}; while( true ) {CPP2_UFCS_TEMPLATE(play<false>)(game);++i;}return false; }())),bool> ) return []() -> bool{clear();auto player1 {CPP2_UFCS_TEMPLATE(cpp2_new<Ai>)(cpp2::shared, Color::Black)}; auto player2 {CPP2_UFCS_TEMPLATE(cpp2_new<Ai>)(cpp2::shared, Color::White)}; auto game {Game(cpp2::move(player1), cpp2::move(player2))}; cpp2::i32 i {0}; while( true ) {CPP2_UFCS_TEMPLATE(play<false>)(game);++i;}return false; }(); else return bool{}; else return bool{}; }

#line 74 "../src/main.cpp2"
                    //player1*.train();
                    //player2*.train();
                    /*if i % 20 == 19 {
                        player1.save();
...
#line 83 "../src/main.cpp2"
            else if (cpp2::impl::is(_expr, 9)) { if constexpr( requires{[]() -> bool{clear();createAi();setNextMessage("AI created.");return false; }();} ) if constexpr( std::is_convertible_v<CPP2_TYPEOF(([]() -> bool{clear();createAi();setNextMessage("AI created.");return false; }())),bool> ) return []() -> bool{clear();createAi();setNextMessage("AI created.");return false; }(); else return bool{}; else return bool{}; }
